...
o = [
    ...
    u'\\d+(分钟|min)',
    u'[13]刻钟',
    u'[上这本下]+(周|星期)([一二三四五六七天日]|[1-7])?',
    u'(周|星期)([一二三四五六七天日]|[1-7])',
    ...
    u'届时',
    u'这个月',
    u'(数|多|多少|好几|几|差不多|近|前|后|上|左右)日',
    u'晚些时候',
    u'今年',
    u'长期',
    u'以前',
    ...
    u'当前',
    u'日(数|多|多少|好几|几|差不多|近|前|后|上|左右)',
    u'\d+点',
    ...
    u'最近',
    u'早上',
    u'早(数|多|多少|好几|几|差不多|近|前|后|上|左右)',
    u'日前',
    u'新世纪',
    u'小时',
    u'([0-3][0-9]|[1-9])[日号]',
    u'明天',
    u'(数|多|多少|好几|几|差不多|近|前|后|上|左右)周',
    u'(数|多|多少|好几|几|差不多|近|前|后|上|左右)([零一二三四五六七八九十百千万]+|\d+)年',
    ...
    u'(昨天(数|多|多少|好几|几|差不多|近|前|后|上|左右)午)',
    u'(年度)',
    u'((数|多|多少|好几|几|差不多|近|前|后|上|左右)星期)',
    u'(年底)',
    u'([下个本]+赛季)',
    u'(今年(\d+)月(\d+)日)',
    u'((\d+)月(\d+)日(数|多|多少|好几|几|差不多|近|前|后|上|左右)午(\d+)时)',
    u'(今年晚些时候)',
    u'(两个星期)',
    u'(过去(数|多|多少|好几|几|差不多|近|前|后|上|左右)周)',
    u'(本赛季)',
    u'(半个(数|多|多少|好几|几|差不多|近|前|后|上|左右))',
    u'(稍晚)',
    u'((\d+)号晚(数|多|多少|好几|几|差不多|近|前|后|上|左右))',
    u'(今(数|多|多少|好几|几|差不多|近|前|后|上|左右)(\d+)年)',
    u'(这个时候)',
    u'((数|多|多少|好几|几|差不多|近|前|后|上|左右)个小时)',
    u'(最(数|多|多少|好几|几|差不多|近|前|后|上|左右)(数|多|多少|好几|几|差不多|近|前|后|上|左右)年)',
    u'(凌晨)',
    u'((\d+)年(\d+)月(\d+)日)|((\d+)个月)',
    u'(今天早(数|多|多少|好几|几|差不多|近|前|后|上|左右))',
    u'(第[一二三四五六七八九十\d+]+季)',
    u'(当地时间)',
    u'(今(数|多|多少|好几|几|差不多|近|前|后|上|左右)([零一二三四五六七八九十百千万]+|\d+)年)',
    u'(早晨)',
    u'(一段时间)',
    u'([本上]周[一二三四五六七])',
    u'(凌晨(\d+)点)',
    ...
    u'(年关)',
    u'(如今)',
    u'((数|多|多少|好几|几|差不多|近|前|后|上|左右)小时)',
    u'(当晚)|((\d+)日晚(\d+)时)',
    u'(([零一二三四五六七八九十百千万]+|\d+)(数|多|多少|好几|几|差不多|近|前|后|上|左右)午)',
    u'(每年(\d+)月(\d+)日)',
    u'(([零一二三四五六七八九十百千万]+|\d+)周)',
    u'((\d+)月)',
    u'(农历)',
    u'(两个小时)',
    u'(本周([零一二三四五六七八九十百千万]+|\d+))',
    u'(长久)',
    u'(清晨)',
    u'((\d+)号晚)',
    u'(春节)',
    u'(星期日)',
    u'(圣诞)',
    u'((数|多|多少|好几|几|差不多|近|前|后|上|左右)段)',
    u'(现年)',
    u'(当日)',
    u'((数|多|多少|好几|几|差不多|近|前|后|上|左右)分钟)',
    u'(\d+(天|日|周|月|年)(后|前|))',
    u'((文艺复兴|巴洛克|前苏联|前一|暴力和专制|成年时期|古罗马|我们所处的敏感)+时期)',
    u'((\d+)[年月天])',
    u'(清早)',
    u'(两年)',
    u'((数|多|多少|好几|几|差不多|近|前|后|上|左右)午)',
    u'(昨天(数|多|多少|好几|几|差不多|近|前|后|上|左右)午(\d+)时)',
    u'(([零一二三四五六七八九十百千万]+|\d+)(数|多|多少|好几|几|差不多|近|前|后|上|左右)年)',
    u'(今(数|多|多少|好几|几|差不多|近|前|后|上|左右)(\d+))',
    u'(圣诞节)',
    u'(学期)',
    u'(\d+来?分钟)',
    u'(过去(数|多|多少|好几|几|差不多|近|前|后|上|左右)年)',
    u'(星期天)',
    u'(夜间)',
    u'((\d+)日凌晨)',
    ...
    u'((\d+)日)',
    u'(((10)|(11)|(12)|([1-9]))月)',
    u'((数|多|多少|好几|几|差不多|近|前|后|上|左右)(数|多|多少|好几|几|差不多|近|前|后|上|左右)年)',
    u'(今年(\d+)月份)',
    u'(晚(数|多|多少|好几|几|差不多|近|前|后|上|左右)(\d+)时)',
    u'(连[年月日夜])',
    u'((\d+)年(\d+)月(\d+)日(数|多|多少|好几|几|差不多|近|前|后|上|左右)午)',
    u'((一|二|两|三|四|五|六|七|八|九|十|百|千|万|几|多|上|\d+)+个?(天|日|周|月|年)(后|前|半|))',
    u'((胜利的)日子)',
    u'(青春期)',
    u'((数|多|多少|好几|几|差不多|近|前|后|上|左右)年)',
    u'(早(数|多|多少|好几|几|差不多|近|前|后|上|左右)([零一二三四五六七八九十百千万]+|\d+)点(数|多|多少|好几|几|差不多|近|前|后|上|左右))',
    u'([0-9]{4}年)',
    u'(周末)',
    u'(([零一二三四五六七八九十百千万]+|\d+)个(数|多|多少|好几|几|差不多|近|前|后|上|左右)小时)',
    ...
    u'((\d+)天)',
    u'(元宵节)',
    u'((数|多|多少|好几|几|差不多|近|前|后|上|左右)分)',
    u'((\d+)月(\d+)日(数|多|多少|好几|几|差不多|近|前|后|上|左右)午)',
    u'(晚(数|多|多少|好几|几|差不多|近|前|后|上|左右)(\d+)时(\d+)分)',
    u'(傍晚)',
    u'(周([零一二三四五六七八九十百千万]+|\d+))',
    ...
    u'(新年)',
    u'(本周)',
    u'(当地时间星期([零一二三四五六七八九十百千万]+|\d+))',
    u'(([零一二三四五六七八九十百千万]+|\d+)(数|多|多少|好几|几|差不多|近|前|后|上|左右)岁)',
    u'(半小时)',
    u'(每周)',
    ...
    u'(周日)',
    u'(晚(数|多|多少|好几|几|差不多|近|前|后|上|左右))',
    u'(今后)',
    ...
    u'(去年底)',
    u'(最后一[天刻])',
    u'(最(数|多|多少|好几|几|差不多|近|前|后|上|左右)(数|多|多少|好几|几|差不多|近|前|后|上|左右)个月)',
    u'(圣诞节?)',
    u'(下?个?(星期|周)(一|二|三|四|五|六|七|天))',
    ...
    u'(现如今)',
    u'([上中下]+午)',
    u'(第(一|二|三|四|五|六|七|八|九|十|百|千|万|几|多|\d+)+个?(天|日|周|月|年))',
    u'(昨晚)',
    u'(近年)',
    u'(今天清晨)',
    u'(中旬)',
    ...
    u'(星期)',
    u'(昨天晚(数|多|多少|好几|几|差不多|近|前|后|上|左右))',
    u'(较早时)',
    u'(个(数|多|多少|好几|几|差不多|近|前|后|上|左右)小时)',
    u'((民主高中|我们所处的|复仇主义和其它危害人类的灾难性疾病盛行的|快速承包电影主权的|恢复自我美德|人类审美力基础设施|饱受暴力、野蛮、流血、仇恨、嫉妒的|童年|艰苦的童年)+时代)',
    u'(元旦)',
    u'(([零一二三四五六七八九十百千万]+|\d+)个礼拜)',
    u'(昨日)',
    u'([年月]初)',
    u'((\d+)年的(\d+)月)',
    u'(每年)',
    u'(([零一二三四五六七八九十百千万]+|\d+)月份)',
    u'(今年(\d+)月(\d+)号)',
    u'(今年([零一二三四五六七八九十百千万]+|\d+)月)',
    u'((\d+)月底)',
    u'(未来(\d+)年)',
